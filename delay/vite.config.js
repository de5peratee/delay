    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/css/musicianProfile.css',
                ...
                'resources/js/updateTrack.js',
                'resources/js/editProfileValidation.js',
                'resources/js/editTrackValidation.js',
                'resources/js/deleteTrack.js',
            ],
            refresh: true,
        }),
    ],
